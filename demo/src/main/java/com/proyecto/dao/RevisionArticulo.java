...
public class RevisionArticulo {
    ...
    {
        GestionArchivosTxt gestionArchivoRevisiones = new GestionArchivosTxt("revisiones");
        String lineaRevisionParaArchivo =  this.codUnico + Constants.SEPARATOR
                + this.codUnicoArticulo + Constants.SEPARATOR
                + this.codUnicoAsignado + Constants.SEPARATOR
                + this.estadoRevision + Constants.SEPARATOR
                + this.comentario;
        gestionArchivoRevisiones.agregarLinea(lineaRevisionParaArchivo);
    }
}
